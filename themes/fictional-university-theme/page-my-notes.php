  ...
  while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
      <div class="create-note">
        ...
        <textarea name="" id="" placeholder="Your Note Here" class="new-note-body"></textarea>
        <span class="submit-note">Create Note</span>
        <span class='note-limit-message'>Note Limit Reached, Please delete one Note to make a room for another note.</span>
      </div>
